# Emits the R19 findings.md deliverable. Content held as a Python string to
# avoid shell heredoc quoting issues. This is a tool-input file, not a report.
from pathlib import Path

OUT = Path(r"c:\Users\Gebruiker\Documents\gevoelscore-app\docs\research\analyses\descriptive\phase_axis_signals\findings.md")

DOC = r'''# Findings -- R19 phase-axis signal shapes (scorecard backdrop)
