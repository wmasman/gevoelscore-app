...
**Status**: **LOCKED r1 2026-07-15** by user delegation (Stage D producer-mode audit landing behind Q24 MD LOCKED r1 2026-07-15). Producer-mode artefact per [CONVENTIONS §1.1](../../../CONVENTIONS.md#11-producer-mode-claude-writes--edits--runs) + [§2.1 descriptive-before-inference](../../../CONVENTIONS.md#21-descriptive-before-inference). Fresh-session [`/research-review`](../../../../.claude/commands/research-review.md) recommended before any Stage H per-HA pre-registration draws on §5 branch verdicts here.
...
|---|---:|---:|---:|---:|---|---:|---:|---:|
| total_steps | +3d | 109 | 145 | **−1356** | [−2054, −665] | 3 | 620 | 1 |
| total_steps | +5d | 43 | 96 | **−3865** | [−5455, −2290] | 5 | 1010 | 1 |
| total_steps | +10d | 11 | 22 | **−15316** | [−20523, −9955] | 10 | 2124 | 1 |
| effective_exertion_min | +3d | 109 | 148 | **+3.55** | [+0.25, +7.17] | 2 | 1.87 | 2 |
| effective_exertion_min | +5d | 43 | 100 | +0.69 | [−4.62, +6.77] | 2 | 1.62 | 6 |
| effective_exertion_min | +10d | 11 | 22 | **−23.08** | [−30.94, −14.70] | 10 | 3.72 | 1 |
| vigorous_min | +3d | 109 | 145 | **−1.72** | [−2.28, −1.21] | 2 | 0.68 | 1 |
| vigorous_min | +5d | 43 | 96 | **−4.26** | [−5.53, −3.07] | 3 | 0.98 | 1 |
| vigorous_min | +10d | 11 | 22 | **−14.51** | [−17.95, −11.24] | 8 | 1.87 | 1 |
| active_min | +3d | 109 | 148 | **−15.27** | [−29.76, −0.97] | 2 | 8.35 | 1 |
| active_min | +5d | 43 | 100 | **−47.26** | [−75.28, −19.33] | 3 | 12.34 | 1 |
| active_min | +10d | 11 | 22 | **−228.95** | [−327.50, −126.13] | 10 | 34.60 | 1 |
...
|---|---:|---:|---:|---:|---|---:|---:|
| sleep_duration_min | +3d | 109 | 133 | **+74.15** | [+40.11, +107.45] | 2 | 32.74 |
| sleep_duration_min | +5d | 43 | 88 | **+180.0** | [+107.6, +252.8] | 4 | 41.11 |
| sleep_duration_min | +10d | 11 | 21 | **+279.1** | [+72.9, +464.2] | 5 | 45.86 |
| sleep_deep_min | +3d | 109 | 133 | **−23.85** | [−42.87, −4.77] | 2 | 12.36 |
| sleep_deep_min | +5d | 43 | 88 | +11.72 | [−16.10, +40.14] | 5 | 12.98 |
| sleep_deep_min | +10d | 11 | 21 | **+308.3** | [+149.3, +522.1] | 10 | 44.87 |
| sleep_rem_min | +3d | 109 | 128 | +12.90 | [−11.42, +38.44] | 1 | 12.02 |
| sleep_rem_min | +5d | 43 | 84 | −25.20 | [−87.67, +34.65] | 5 | 12.61 |
| sleep_rem_min | +10d | 11 | 20 | **−139.6** | [−240.9, −39.3] | 6 | 20.85 |
| sleep_awake_min | +3d | 109 | 133 | +1.62 | [−1.87, +5.34] | 1 | 1.89 |
| sleep_awake_min | +5d | 43 | 88 | +2.79 | [−4.68, +9.99] | 4 | 1.85 |
| sleep_awake_min | +10d | 11 | 21 | **−11.24** | [−21.34, −0.90] | 10 | 2.87 |
| sleep_efficiency_tib | +3d | 109 | 133 | −0.001 | [−0.006, +0.005] | 3 | 0.005 |
| sleep_efficiency_tib | +5d | 43 | 88 | −0.001 | [−0.011, +0.010] | 1 | 0.004 |
| sleep_efficiency_tib | +10d | 11 | 21 | +0.016 | [−0.010, +0.041] | 10 | 0.007 |
| sleep_light_min | +3d | 109 | 133 | **+89.19** | [+54.44, +123.37] | 2 | 33.63 |
...
| outcome | window | n_t | n_c | AUC | AUC 95% CI | k\* | p_mag | fcd |
|---|---:|---:|---:|---:|---|---:|---:|---:|
| stress_mean_sleep | +3d | 109 | 133 | −0.74 | [−3.18, +1.75] | 2 | 1.07 | 4 |
| stress_mean_sleep | +5d | 43 | 88 | −4.16 | [−9.84, +1.92] | 2 | 2.29 | 2 |
| stress_mean_sleep | +10d | 11 | 21 | +14.90 | [−28.85, +50.99] | 9 | 4.06 | 11 |
| all_day_stress_avg | +3d | 109 | 148 | −1.06 | [−3.74, +1.56] | 1 | 0.81 | 4 |
| all_day_stress_avg | +5d | 43 | 100 | **−6.68** | [−12.74, −0.13] | 1 | 1.84 | 6 |
| all_day_stress_avg | +10d | 11 | 22 | **−33.14** | [−54.75, −8.54] | 10 | 5.35 | 6 |
| bb_lowest | +3d | 109 | 148 | −0.02 | [−4.62, +4.62] | 1 | 1.82 | 4 |
| bb_lowest | +5d | 43 | 100 | **+13.60** | [+2.76, +24.03] | 5 | 4.95 | 2 |
| bb_lowest | +10d | 11 | 22 | **+76.00** | [+35.09, +112.18] | 10 | 12.20 | 1 |
| hr_median_waking | +3d | 109 | 148 | **+3.51** | [+1.36, +5.66] | 2 | 1.64 | 2 |
| hr_median_waking | +5d | 43 | 99 | +2.59 | [−2.00, +7.48] | 4 | 1.07 | 6 |
| hr_median_waking | +10d | 11 | 22 | +5.83 | [−7.15, +18.20] | 8 | 1.71 | 11 |
| sleep_hr_avg_spo2 | +3d | 109 | 129 | **+2.30** | [+0.26, +4.34] | 1 | 1.17 | 1 |
| sleep_hr_avg_spo2 | +5d | 43 | 78 | +2.53 | [−2.27, +7.42] | 1 | 0.88 | 6 |
| sleep_hr_avg_spo2 | +10d | 11 | 19 | −6.62 | [−22.90, +9.09] | 10 | 2.60 | 11 |
...
| outcome | window | n_t | n_c | AUC | AUC 95% CI | k\* | p_mag |
|---|---:|---:|---:|---:|---|---:|---:|
| sleep_efficiency_staged | +3d | 109 | 128 | +0.005 | [−0.001, +0.010] | 3 | 0.005 |
| sleep_efficiency_staged | +5d | 43 | 84 | +0.011 | [−0.003, +0.024] | 4 | 0.005 |
| sleep_efficiency_staged | +10d | 11 | 20 | +0.032 | [+0.009, +0.056] | 10 | 0.006 |
| spo2_avg_sleep | +3d | 109 | 114 | +0.10 | [−0.30, +0.51] | 3 | 0.24 |
| spo2_avg_sleep | +5d | 43 | 72 | −0.11 | [−1.05, +0.75] | 3 | 0.42 |
| spo2_avg_sleep | +10d | 11 | 15 | **−8.06** | [−12.48, −3.52] | 10 | 1.87 |
| asleep_stress_max_uds | +3d | 109 | 146 | +1.83 | [−4.87, +8.68] | 3 | 2.98 |
| asleep_stress_max_uds | +5d | 43 | 100 | **−19.86** | [−33.92, −5.93] | 3 | 6.09 |
| asleep_stress_max_uds | +10d | 11 | 22 | **−66.45** | [−109.26, −24.58] | 10 | 9.06 |
...
|---|---:|---:|---:|---:|---|---:|---:|---:|
| compensatory-success | +3d | 109 | 118 | **−0.47** | [−0.83, −0.12] | 2 | 0.22 | 1 |
| compensatory-success | +5d | 43 | 76 | −0.78 | [−1.57, +0.04] | 1 | 0.38 | 1 |
| compensatory-success | +10d | 11 | 17 | +0.16 | [−1.72, +1.98] | 7 | 0.37 | 11 |
| compensatory-failure | +3d | 16 | 118 | **−3.77** | [−4.84, −2.77] | 2 | 1.42 | 1 |
| compensatory-failure | +5d | 9 | 76 | **−5.33** | [−7.17, −3.51] | 2 | 1.20 | 1 |
| compensatory-failure | +10d | 1 | 17 | — | — | — | — | — |
...
| all_day_stress_avg | **BOTH decay** | ONLY subjective decays | ONLY subjective decays |
| bb_lowest | ONLY subjective decays | ONLY subjective decays | ONLY subjective decays |
| hr_median_waking | ONLY subjective decays | **BOTH decay** | **BOTH decay** |
| sleep_hr_avg_spo2 | ONLY subjective decays | **BOTH decay** | **BOTH decay** |
...
| channel | +3d | +5d | +10d |
|---|---|---|---|
| stress_mean_sleep | NEITHER decays | NEITHER decays | ONLY autonomic decays |
| all_day_stress_avg | NEITHER decays | ONLY autonomic decays | ONLY autonomic decays |
| bb_lowest | NEITHER decays | NEITHER decays | ONLY autonomic decays |
| hr_median_waking | NEITHER decays | NEITHER decays | ONLY autonomic decays |
| sleep_hr_avg_spo2 | NEITHER decays | NEITHER decays | ONLY autonomic decays |
...
**36 raw-only findings** (in the detrend-erasing set, §6.1) are trajectory-confound-suspect. **8 detrend-only findings** (§6.2) are also trajectory-confound-suspect but in the opposite direction (envelope drift was hiding them). **Neither set overturns Stage D descriptive verdicts on its own**; both flag Stage H pre-reg targets that must be justified against the detrended reading before advancing.

**The most robust Stage D findings** — those where raw AND detrended AUC CIs both exclude zero (raw significant AND detrend significant, same sign) — are the smallest set: 15 − 8 = **7 cells** total. These are the trajectory-confound-*surviving* signals worth prioritising for Stage H pre-reg drafting in Wave 2, subject to independent verification.
...
**Comparator pool sizes** per outcome × window are recomputed per Q24 MD §4.2. Compensatory-success (n=109) matched-ordinary comparator pools range from ~120 (gevoelscore, 90% base coverage) to ~148 (activity/day autonomic, 98% base coverage) at +3d; shrink to ~76-100 at +5d; ~15-22 at +10d.
...
| 8 | Envelope-drift asymmetry (L2.2 stationarity) in comparator pool | **RELEVANT** — matched-ordinary comparator draws from full LC-era. The 36 detrend-erasing cells (§6.1) are directly the envelope-drift signal Q24 MD §10 item 8 predicted; the 8 detrend-surfacing cells (§6.2) are the same confound in the opposite direction on the failure pool. Per Q24 MD §10 item 8, era-stratified comparator sensitivity arm (calendar-year match) is a Wave 2 candidate companion for any finding that survives detrending. |
