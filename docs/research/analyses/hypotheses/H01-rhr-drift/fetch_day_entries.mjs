...
// into a local CSV the Python test scripts read from. Keeps secrets
// (DIRECTUS_TOKEN) in Node-land, away from the Python analysis layer.
//
// Run:
//   powershell -ExecutionPolicy Bypass -File scripts/run-directus-script.ps1 `
//     -Script docs/research/garmin/hypotheses/H01-rhr-drift/fetch_day_entries.mjs
