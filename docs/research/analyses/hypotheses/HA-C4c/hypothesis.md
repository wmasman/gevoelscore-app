...
**Status**: **r2 drafted, not locked. Awaiting fresh-session re-audit per user-selected Option γ** (REVISION RECOMMENDED label warrants the canonical 4-stage discipline despite mechanical-absorb scope).
