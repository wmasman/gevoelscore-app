...
*Pre-registration drafted 2026-06-22 by Claude (Opus 4.7) in producer-mode under user authorisation per [CONVENTIONS §1.1](../../../CONVENTIONS.md#11-producer-mode-claude-writes--edits--runs). r2 LOCKED 2026-06-23 by user acceptance per [`hypothesis_lock_process.md` §3.5 + §3.6 + §3.8](../../../methodology/hypothesis_lock_process.md#38-lock-step-stage-5-of-the-arc); audit report [HA11-bout-redo-2026-06-22.md](../../../reviews/HA11-bout-redo-2026-06-22.md) (PASS-with-caveats). Next stage: post-lock test execution (separate session) per [`hypothesis_lock_process.md` §3.9](../../../methodology/hypothesis_lock_process.md#39-run-step-post-lock).*
