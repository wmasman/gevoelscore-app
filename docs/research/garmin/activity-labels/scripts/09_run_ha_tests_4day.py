"""Run HA01b + HA02b + HA05b pre-registered tests (4-day lead-up window).

Variant of script 08 with widened lead-up window [D-4, D-3, D-2, D-1],
motivated by participant's experiential PEM lag (typical trigger 2-3
days before crash_start, occasionally up to 4 days). Pre-registered
2026-06-06 in hypotheses.md.

Output: ha_results_4day.md + ha_results_4day.json.
"""
...
OUT_MD = ROOT / "output" / "ha_results_4day.md"
OUT_JSON = ROOT / "output" / "ha_results_4day.json"

ANALYSIS_START = date(2022, 9, 3)
TRAIN_END = date(2023, 12, 31)
VALIDATE_END = date(2026, 6, 5)
LEADUP_DAYS = 4   # 4-day lead-up window per hypotheses.md HA01b/HA02b
