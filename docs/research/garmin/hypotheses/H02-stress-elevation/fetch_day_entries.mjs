// One-shot fetcher: pulls all day_entries (date, score) from Directus
// into a local CSV the Python test reads from. Duplicate of H01's
// fetcher — kept per-hypothesis so each test has clear ownership of
// its input snapshot.
//
// Run:
//   powershell -ExecutionPolicy Bypass -File scripts/run-directus-script.ps1 `
//     -Script docs/research/garmin/hypotheses/H02-stress-elevation/fetch_day_entries.mjs
