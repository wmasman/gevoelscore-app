...
| [runbooks/rotate-credentials.md](runbooks/rotate-credentials.md) | Rotating the Directus static token, Neon password, or admin password. |
| [runbooks/wipe-and-rebootstrap.md](runbooks/wipe-and-rebootstrap.md) | Nuclear option — wipe Neon DB and re-run schema/permissions setup. |
