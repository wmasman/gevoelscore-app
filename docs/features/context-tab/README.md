...
- **Naming**: the tab is **Verloop** (not "Context"). See [verloop-and-episodes/README.md §Naming](../verloop-and-episodes/README.md#naming).
...
- **Timeline visualisation**: moved into its own feature, [features/timeline-episode-overlay/](../timeline-episode-overlay/), to ship after Verloop+Episodes lands.
